                            ...
                            <div class="card-body">
                                <form name='loginForm' id="loginForm"
                                    ...
                                    <div style="margin-top: -20px">
                                        <img class="" src="<c:url value="/resources/img/brand/logo.png"/>" width="" height="100" alt="">
                                        <img class="" src="<c:url value="/resources/img/brand/logo-text.svg"/>" width="260" height="100" alt="">
                                    </div>
                                    <hr>    
                                    <div>
                                        <h1>Login</h1>
